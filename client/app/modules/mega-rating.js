...
(function() {
  angular.module('mega.rating', []).constant('ratingConfig', {
    max: 5
    ...
    return {
      ...
      template: '<ul class="rating" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)"><i class="icon fa" ng-class="value === undefined ? (r === 1 ? \'fa-star\' : (r === 2 ? \'fa-star-half-o\' : \'fa-star-o\')) : (value > $index ? (value < $index+1 ? \'fa-star-half-o\' : \'fa-star\') : \'fa-star-o\')"></i></li>' + '</ul>',
      replace: true,
